...
export default function App({ Component, pageProps }: AppProps) {
    return (
        <>
            <Script
                async
                src="https://www.googletagmanager.com/gtag/js?id=UA-128628977-2"
            />
            <Head>
                ...
                <meta
                    property="og:url"
                    content="https://prismarinejs.github.io/"
                />
                <meta
                    property="og:description"
                    content="A Minecraft server, bot, and API all written in JavaScript"
                />
                ...
                <link
                    rel="icon"
                    href="static/images/js_mini_icon.png"
                    type="image/x-icon"
                />
                <link
                    rel="icon"
